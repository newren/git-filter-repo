...
###############################################################################
  ...
  #############################################################################
    ...
    # See if original unmodified commit had file changes. If it did not,
    # then we should not skip this commit. Commits without file-changes
    # usually come from importing commits from another system (like CVS)
